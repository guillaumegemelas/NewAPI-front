...
export default function Divertissement(props) {
  return (
    <div className="container px-3 pt-5 ">
      <h2 className="text-center fw-bolder my-2">Actualités Divertissement</h2>
...
export async function getStaticProps() {
  //   const result = await fetch("http://localhost:3000/getnewsentertainment");
  const result = await fetch(
    "https://site--news-api-back--zqfvjrr4byql.code.run/getnewsentertainment"
  );
